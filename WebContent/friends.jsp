...
<body>
	<div id="header">
		...
		<div id="mainMenu">
			<img id="menuLeft" src="images/menuLeft.gif" alt="左滑动" /> <img
				...
				id="menuMasker" src="images/menuBlock.gif" style="left: 267px;"
				alt="蒙" />
			<ul>
				...
				<li><s:a href="friends.jsp" class="over">博 友</s:a></li>
	...
	<div id="left">
		<div class="ListItem">
			...
			<ul class="ulBox">
				<s:iterator>
					<li><img class="friendphoto" src="images/friendlogo.gif"
						alt="博友头像" />
						<div>
							<strong><s:a href="#">张三</s:a></strong> <span>年龄：20</span> <span>所在地：河北
								唐山</span> <span>最后登录：2010-05-05</span>
						</div> <s:a href="#" class="comm">发送消息</s:a> <s:a href="#" class="comm">删除</s:a>
					</li>
			</s:iterator>
			</ul>
		</div>
