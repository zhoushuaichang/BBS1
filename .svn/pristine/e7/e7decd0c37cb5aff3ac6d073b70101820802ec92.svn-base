...
<body>
	<div id="header">
		...
		<div id="mainMenu">
			...
			<img id="menuMasker" src="images/menuBlock.gif" style="left: 120px;"
				alt="蒙" />
			<ul>
	...
	<div id="left">
		<div class="ListItem">
			<div class="ListItemTop">
				<span>当前位置 > 日志 > Dreamweaver CS4中使用CSS3属性提示</span>
			</div>
			...
			<s:a href="javascript:window.close()"
				style="float: right; margin-top: 20px;">[关闭窗口]</s:a>
		</div>
	</div>
